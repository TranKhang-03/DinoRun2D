...
public class Player : MonoBehaviour
{
    ...
    private void HandleSoundEffects()
    {
        ...
        if (isGrounded && !AudioManager.instance.HasPlayedEffectsSound())
        {
            AudioManager.instance.PlayTapClip();
            AudioManager.instance.SetHasPlayedEffectsSound(true);
        }
        else if (!isGrounded)
        {
            AudioManager.instance.SetHasPlayedEffectsSound(false);
        }
    }
